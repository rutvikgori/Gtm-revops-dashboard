...
![GTM Executive Health](query1_coverage_summary.png)

### Coverage Gaps & Whitespace
![Whitespace Accounts](query2_whitespace_accounts.png)

### Rep Territory Balance
![Rep Territory Balance](query3_rep_territory_balance.png)

### Pipeline Coverage
![Pipeline Coverage](query4_pipeline_coverage.png)

### Activity Effectiveness
![Activity Effectiveness](query5_activity_effectiveness.png)

### Forecast Trend
![Forecast Trend](query6_forecast_trend.png)

### Stale Accounts
![Stale Accounts](query7_stale_accounts.png)
## SQL Techniques Used
